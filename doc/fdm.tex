...
\end{python}
with \pythoninline{data} a tuple containing the main variables, \pythoninline{z} the node z-positions as defined above, \pythoninline{l} the height vector of the elements, \pythoninline{index} the index of re-ordered mesh locations, and \pythoninline{dt} the time step of the program, $\Delta t$.
